...
class BasicAircraftControlVM : DJIViewModel() {
    ...
    fun turnOnMotors(callback: CommonCallbacks.CompletionCallbackWithParam<EmptyMsg>) {
    ...
    fun turnOffMotors(callback: CommonCallbacks.CompletionCallbackWithParam<EmptyMsg>) {
